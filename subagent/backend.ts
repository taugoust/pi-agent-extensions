...
export function selectSubagentBackend(bridge: AdaptiveSubagentBridge | undefined, agentSHExpected = false): AdaptiveSubagentBackend {
  ...
  const adapter = bridge?.subagentAdapter as { execute?: unknown; renderCall?: unknown; renderResult?: unknown } | undefined;
  const adapterValid = typeof adapter?.execute === "function" && typeof adapter.renderCall === "function" && typeof adapter.renderResult === "function";
